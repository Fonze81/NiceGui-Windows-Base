...
EXPECTED_EXPORTS: Mapping[str, Any] = {
    ...
    "SETTINGS_FILE_NAME": constants.SETTINGS_FILE_NAME,
    "SettingsGroup": schema.SettingsGroup,
    "SettingsScopeError": schema.SettingsScopeError,
    "apply_setting_property_to_state": mapper.apply_setting_property_to_state,
    "apply_settings_to_state": mapper.apply_settings_to_state,
    ...
    "resolve_default_settings_path": paths.resolve_default_settings_path,
